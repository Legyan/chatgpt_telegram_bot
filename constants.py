HELP_TEXT = (
    ...
    'в белый список. '
    'Используйте формат: /add_user Name 12345678\n'
    '/del_user - (Только для администраторов) Удалить пользователя '
    'из белого списка. '
    'Используйте формат: /del_user 12345678\n'
    '/reset_tokens - (Только для администраторов) Обнулить счетчик токенов '
    'указанного пользователя. Используйте формат: /reset_tokens 12345678\n'
    ...
    'администратором. '
    'Используйте формат: /add_admin 12345678\n'
    '/del_admin - (Только для администраторов) Удалить права администратора '
    'у пользователя. '
    'Используйте формат: /del_admin 12345678\n'
